    ...
    const datasets = getInitialDatasets({
      ...
      datasets: [
        ...
        },
        {
          ...
          member_id: 'r1i1p1f1',
          method: 'gard',
          name: 'GARD tasmax annual',
          original_dataset_uris: [],
          source_id: 'BCC-CSM2-MR',
          table_id: 'day',
          timescale: 'year',
          uri: 'https://cmip6downscaling.blob.core.windows.net/flow-outputs/results/0.1.7/pyramid/39e162222f988d94',
          variable_id: 'tasmax',
        },
        {
          activity_id: 'CMIP',
          ...
          member_id: 'r1i1p1f1',
          method: 'gard',
          name: 'GARD tasmax monthly',
          original_dataset_uris: [],
          source_id: 'BCC-CSM2-MR',
          table_id: 'day',
          timescale: 'month',
          uri: 'https://cmip6downscaling.blob.core.windows.net/flow-outputs/results/0.1.7/pyramid/b93147ecaca1f7a1',
          variable_id: 'tasmax',
        },
      ],
    })
